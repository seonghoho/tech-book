...
export const aboutProjects: AboutProject[] = [
  ...
  },
  {
    ...
    title: "TripMarble",
    eyebrow: "토이 프로젝트",
    tagline: "여행지 탐색을 미션형 보드게임 루프로 연결한 웹 서비스",
    period: "2025.05 - 2025.09",
    status: "Published",
    posterColor: "#0070f3",
    posterTextColor: "#f8fbff",
    duration: "5개월",
    team: "3명 · FE 2 / BE 1",
    role: "Web 프론트엔드 담당",
    summary:
      "여행지를 탐색하고, 선택한 여행을 게임 루프로 전환해 실제 방문 기록을 미션과 리뷰로 남기는 지역 기반 여행 보드게임 서비스입니다.",
    overview:
      "TripMarble은 여행지 탐색, 게임 생성, 보드 진행, 미션 인증, 리뷰 기록을 하나의 사용자 여정으로 연결하는 웹 서비스입니다.",
    context:
      "여행지 정보 탐색과 게임 플레이가 분리되어 보이지 않도록, 홈 진입, 지역 탐색, 게임 목록, 생성 플로우, 인증 흐름을 웹 화면에서 자연스럽게 이어주는 구조가 필요했습니다.",
    tags: ["travel", "game", "nextjs", "ux"],
    narrative: [
      "TripMarble은 여행지를 탐색하고, 그 여행을 게임 루프로 전환하고, 실제 방문 기록을 미션과 리뷰로 남기는 서비스입니다. 저는 Web 프론트엔드 담당으로 Next.js 기반 웹앱 구조와 주요 사용자 흐름을 다뤘습니다.",
      "홈에서는 3D 주사위와 보드 이미지를 활용해 서비스의 게임성을 먼저 보여주고, 사용자가 게임 만들기나 여행지 탐색으로 진입할 수 있도록 구성했습니다. 검색, 여행지 목록, 게임 목록, 로그인, 프로필 같은 주요 라우트도 웹 경험 안에서 연결했습니다.",
      "이후에는 단순 스타일 통일보다 여행 탐색, 게임 생성, 미션 수행이 하나의 루프로 느껴지도록 서비스 UX를 다시 검토했습니다. 디자인 토큰, 공통 카드, 헤더, 게임 리스트, 지도 중심 화면의 구조를 정리하며 웹 서비스의 확장성을 높이는 방향으로 개선했습니다.",
    ],
    highlightPhrases: [
      "Web 프론트엔드 담당",
      "Next.js 기반 웹앱 구조",
    ...
    cardPoints: [
      "Next.js 기반 Web 앱 구조와 주요 라우트 구성",
      "여행지 탐색, 게임 생성, 게임 목록 흐름 연결",
      "서비스 UX 리뷰와 디자인 시스템 개선 방향 정리",
    ],
    keyContributions: [
      "Next.js App Router 기반으로 홈, 검색, 여행지 목록, 게임 목록, 로그인, 프로필 등 웹 주요 화면의 라우트와 레이아웃을 구성했습니다.",
      "React Query 기반 API 훅과 Redux Persist 기반 클라이언트 상태 흐름을 연결해 사용자, 여행지, 게임, 리뷰 데이터를 웹 화면에서 다룰 수 있게 했습니다.",
      "게임 목록, 카드 레일, 헤더, 푸터, 빈 상태 등 공통 위젯을 정리하고 서비스 화면 전반의 일관성을 높였습니다.",
      "여행지 탐색에서 게임 생성, 보드 진행, 미션 인증으로 이어지는 핵심 흐름을 UX 관점에서 재검토하고 개선 기준을 문서화했습니다.",
    ],
    technicalHighlights: [
      "Next.js 14, TypeScript, Sass 기반으로 app, entities, features, shared, widgets 계층을 나누어 웹 코드를 구성했습니다.",
      "Three.js와 GSAP을 활용한 3D 주사위 홈 히어로로 여행 게임 서비스의 첫인상을 시각화했습니다.",
      "React Query로 여행지, 게임, 리뷰 관련 서버 상태를 관리하고 Redux Toolkit과 redux-persist로 사용자 상태를 유지했습니다.",
      "카드, 리스트, 모달, 버튼, 헤더 같은 공통 UI를 정리해 이후 화면 확장과 리디자인 작업의 기반을 마련했습니다.",
    ],
    techStack: [
      "Next.js",
      "React",
    ...
    outcomes: [
      "여행 탐색, 게임 생성, 게임 목록을 연결한 Web 서비스 흐름 구축",
      "3D 주사위와 보드 연출로 여행 보드게임 서비스의 핵심 인상 강화",
      "서비스 UX 리뷰와 공통 UI 정리로 후속 리디자인 기반 마련",
    ],
    links: [
      {
        label: "서비스 보기",
        href: "https://www.tripmarble.com/",
        external: true,
      },
    ],
    preview: {
      kind: "image",
      src: "/images/projects/tripmarble/cover-og.png",
      alt: "TripMarble 웹 서비스 홈 화면",
      caption: "3D 주사위와 보드 연출로 여행 게임 경험을 보여주는 TripMarble 웹 홈",
      aspect: "wide",
    },
    gallery: [
      {
        kind: "image",
        src: "/images/projects/tripmarble/home-dice.png",
        alt: "TripMarble 3D 주사위 홈 히어로 화면",
        caption: "3D 주사위와 보드 타일로 여행 게임 콘셉트를 보여주는 홈 히어로",
        aspect: "landscape",
      },
      {
        kind: "image",
        src: "/images/projects/tripmarble/cover-og.png",
        alt: "TripMarble 웹 서비스 홈 화면",
        caption: "여행지 탐색과 게임 만들기 진입을 연결한 웹 홈 화면",
        aspect: "landscape",
      },
      {
        kind: "image",
        src: "/images/projects/tripmarble/search.png",
        alt: "TripMarble 여행지 검색 화면",
        caption: "추천 여행지와 검색 입력을 통해 여행 탐색을 시작하는 화면",
        aspect: "landscape",
      },
      {
        kind: "image",
        src: "/images/projects/tripmarble/spots.png",
        alt: "TripMarble 여행지 목록과 지도 화면",
        caption: "장소 목록, 카테고리 필터, 지도를 함께 배치한 여행지 탐색 화면",
        aspect: "landscape",
      },
      {
        kind: "image",
        src: "/images/projects/tripmarble/game-detail.png",
        alt: "TripMarble 게임 진행 화면",
        caption: "생성된 여행 게임의 보드, 미션 인증, 타임라인을 확인하는 화면",
        aspect: "landscape",
      },
    ],
  },
  {
    ...
    title: "Cherry Wish",
    eyebrow: "토이 프로젝트",
    tagline: "벚꽃나무와 꽃잎으로 오늘의 소원을 건네는 단일 페이지 인터랙션",
    period: "2026.03",
    status: "Published",
    posterColor: "#f9a8d4",
    posterTextColor: "#4a044e",
    duration: "개인 토이 프로젝트",
    team: "개인 프로젝트",
    role: "기획·디자인·프론트엔드",
    summary:
      "벚꽃나무를 누르면 꽃잎이 떨어지고, 그 꽃잎을 잡으면 오늘의 소원 메시지를 확인할 수 있는 단일 페이지 인터랙티브 프로젝트입니다.",
    overview:
      "Cherry Wish는 짧고 직관적인 봄 시즌 인터랙션을 통해 사용자가 가볍게 참여하고 다시 시도할 수 있도록 만든 웹 경험입니다.",
    context:
      "복잡한 기능보다 한 화면 안에서 바로 이해되는 감성적인 상호작용, 모바일에서도 부드러운 애니메이션, 다시 하기까지 자연스럽게 이어지는 반복 구조에 집중했습니다.",
    tags: ["toy", "interaction", "animation", "seasonal"],
    narrative: [
      "Cherry Wish는 벚꽃나무를 누르고, 흩날리는 꽃잎을 잡아 오늘의 소원 메시지를 확인하는 단일 페이지 인터랙티브 프로젝트입니다. 짧은 시간 안에 사용자가 바로 이해하고 참여할 수 있는 감성적인 봄 시즌 경험으로 설계했습니다.",
      "나무를 누르면 꽃잎이 흩날리고, 꽃잎을 잡으면 메시지가 열리는 흐름을 중심에 두었습니다. 모바일에서도 가볍고 부드럽게 느껴지도록 애니메이션과 반복 플레이 구조를 단순하게 유지했습니다.",
      "React, TypeScript, Pixi.js, GSAP을 사용해 캔버스 기반 시각 효과와 UI 상태를 연결했고, Vite 기반으로 빠르게 배포 가능한 작은 인터랙션 프로젝트로 완성했습니다.",
    ],
    highlightPhrases: [
      "단일 페이지 인터랙티브 프로젝트",
      "벚꽃나무",
    ...
    cardPoints: [
      "벚꽃나무를 중심으로 한 단일 화면 인터랙션",
      "꽃잎을 잡으면 소원 메시지가 열리는 감성 UX",
      "Pixi.js·GSAP 기반의 가벼운 애니메이션 흐름",
    ],
    keyContributions: [
      "벚꽃나무를 누르고 꽃잎을 잡는 짧은 상호작용을 한 화면 안에서 이해할 수 있도록 기획하고 구현했습니다.",
      "꽃잎이 흩날리는 애니메이션과 소원 메시지 표시 흐름을 연결해 사용자의 행동이 즉시 결과로 이어지게 만들었습니다.",
      "모바일에서도 부담 없이 실행되도록 화면 구조와 인터랙션 단계를 단순하게 유지했습니다.",
      "다시 하기까지 자연스럽게 이어지는 반복 플레이 구조를 만들어 짧은 경험의 완성도를 높였습니다.",
    ],
    technicalHighlights: [
      "React와 TypeScript 기반으로 UI 상태를 구성하고 Vite로 가볍게 빌드·배포할 수 있는 구조를 사용했습니다.",
      "Pixi.js와 GSAP을 활용해 벚꽃나무와 꽃잎 애니메이션을 구현했습니다.",
      "단일 페이지 경험에 맞춰 인터랙션 단계와 안내 문구를 최소화해 첫 방문자가 바로 사용할 수 있게 했습니다.",
    ],
    techStack: ["React", "TypeScript", "Pixi.js", "GSAP", "Vite", "CSS"],
    outcomes: [
      "누르기, 잡기, 메시지 확인으로 이어지는 짧고 명확한 인터랙션 완성",
      "모바일에서도 부담 없이 볼 수 있는 계절성 웹 경험 구현",
      "개인 도메인에 배포 가능한 독립 토이 프로젝트로 정리",
    ],
    links: [
      {
        label: "서비스 보기",
        href: "https://wish.seonghoho.com/",
        external: true,
      },
      {
        label: "GitHub",
        href: "https://github.com/seonghoho/cherry-wish",
        external: true,
      },
    ],
    preview: {
      kind: "image",
      src: "/images/projects/cherry-wish/cover-og.png",
      alt: "Cherry Wish 벚꽃 소원나무 화면",
      caption: "벚꽃나무를 누르고 꽃잎을 잡아 소원 메시지를 확인하는 단일 페이지 인터랙션",
      aspect: "wide",
    },
    gallery: [
      {
        ...
        src: "/images/projects/cherry-wish/cover-og.png",
        alt: "Cherry Wish 벚꽃 소원나무 화면",
        caption: "나무를 누르고 꽃잎을 잡는 흐름을 중심으로 구성한 봄 시즌 인터랙션",
        aspect: "landscape",
      },
    ],
  },
