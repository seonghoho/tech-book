...
당시 진행하던 프로젝트에서 3D 수학 교구를 제작하고 있었습니다.
...
![Three.js 카메라 객체 전체를 복사하지 않고 position quaternion zoom 같은 순수 cameraState만 저장한 뒤 camera에 수동 복원하는 구조](/images/posts/svg-editor/three-js-camera-state/body-01.png)
