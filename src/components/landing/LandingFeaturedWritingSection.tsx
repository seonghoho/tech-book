  ...
  return (
    <article
      className={joinClasses(
        "surface-panel group flex h-full min-w-0 flex-col border border-[color:var(--color-border)] p-5 transition-[transform,border-color,box-shadow] duration-200 ease-out hover:-translate-y-1 hover:border-[color:var(--color-border-strong)] hover:shadow-[0_24px_60px_rgba(15,23,42,0.08)] dark:hover:shadow-[0_28px_70px_rgba(2,8,23,0.34)] sm:p-6",
